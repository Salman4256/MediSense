...
class DashboardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupPersonalizedGuidanceButton()
    ...
    private fun setupPersonalizedGuidanceButton() {
        binding.btnPersonalizedGuidance.setOnClickListener {
            findNavController().navigate(R.id.action_dashboardFragment_to_personalizedGuidanceFragment)
        }
    }
    ...
    private fun setupToolbar() {
        binding.toolbar.setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.action_decision_traces -> {
                    findNavController().navigate(R.id.action_dashboardFragment_to_healthDecisionTraceFragment)
                    true
                }
                R.id.action_health_sharing -> {
    ...
    private fun setupDecisionTracesButton() {
        binding.btnDecisionTraces.setOnClickListener {
            findNavController().navigate(R.id.action_dashboardFragment_to_healthDecisionTraceFragment)
        }
    }
